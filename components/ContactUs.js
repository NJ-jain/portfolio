        ...
        <div className="contact-content">
          <div className="column left">
            ...
            <div className="icons">
              ...
              {/* Fixed anchor tag issue */}
              <a href="https://www.instagram.com/bro.naman662/" style={{ textDecoration: "none", color: "#333" }}>
                <div className="row">
                  ...
                  <div className="info">
                    ...
                    <div className="sub-title">Naman Jain</div>
                  </div>
                </div>
              </a>
              ...
              <div className="row">
                ...
                <div className="info">
                  ...
                  <div className="sub-title">&nbsp;Shed A-1 Matra Shri Collection Ashoka Garden, Bhopal</div>
                </div>
              </div>
              ...
              <div className="social-menu">
                <ul>
                  <li><a href="https://github.com/NJ-jain"><svg xmlns="http://www.w3.org/2000/svg" x="30px" y="30px" width="30" height="30" viewBox="0 0 30 30">
                  ...
                  <li><a href="https://www.linkedin.com/in/naman-jain-a46b9b223/"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
                  ...
                  <li><a href="https://www.instagram.com/bro.naman662/"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
